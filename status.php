...
<body>
    ...
    <div class="container"><img class="img-circle center-block" src="assets/img/default.png" width="140" height="140">
        <h1 class="text-center">francis <button class="btn btn-default btn-primary follow-button" type="button">Follow </button></h1>
